...
function draw() {
    ...
    drawBall(canvaswidth/5 + boxlength*1.5 + w_ss_scale*w, canvasheight/2 - F0/Math.sqrt((k-m*w*w)*(k-m*w*w)+w*w*c*c),0.08,"white")
    ...
    if (w<Math.sqrt(k/m)){
    	drawBall(canvaswidth/5 + boxlength*1.5 + w_ss_scale*w, 0.95*canvasheight - Math.atan(c*w/(k-m*w*w)),0.08,"white")
    } else{
    	drawBall(canvaswidth/5 + boxlength*1.5 + w_ss_scale*w, 0.95*canvasheight - Math.PI - Math.atan(c*w/(k-m*w*w)),0.08,"white")
    }
}
...
function simulate_calcs() {
    ...
    Fscale = 500;
    drawArrowSmall(canvaswidth/5 - boxlength*0.75, canvasheight/2 + x_1, canvaswidth/5 - boxlength*0.75, canvasheight/2 + x_1 - (F0/Fscale)*Math.cos(w*timer),"#1E90FF")
    drawBall(canvaswidth/5 + boxlength*1.5 + w_ss_scale*w, canvasheight/2 - F0/Math.sqrt((k-m*w*w)*(k-m*w*w)+w*w*c*c),0.08,"white")
